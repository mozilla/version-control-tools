#require bmodocker
  ...
  Bugzilla accessible on http://$DOCKER_HOSTNAME:$HGPORT1/
...
Pushing to mozilla-inbound will result in bug being updated
  ...
  recording push at http://$DOCKER_HOSTNAME:$HGPORT1/show_bug.cgi?id=1
...
Pushing multiple changesets with multiple bugs will result in bug being updated
  ...
  recording push at http://$DOCKER_HOSTNAME:$HGPORT1/show_bug.cgi?id=2
  recording push at http://$DOCKER_HOSTNAME:$HGPORT1/show_bug.cgi?id=3
...
Pushing to Try will post Treeherder comment
  ...
  recording Treeherder push at http://$DOCKER_HOSTNAME:$HGPORT1/show_bug.cgi?id=4
  ...
  Bug 4:
    ...
    - author: default@example.com
      id: 8
      tags: []
      text: https://treeherder.mozilla.org/#/jobs?repo=try&revision=f003bc004db3521dc84c88bbb07c1b63e1e7761f
    component: TestComponent
    depends_on: []
    platform: All
    product: TestProduct
...
Public changesets pushed to Try will be ignored if a bug in draft changesets
  ...
  remote: adding file changes
  remote: added 3 changesets with 3 changes to 1 files (+1 heads)
  recording Treeherder push at http://$DOCKER_HOSTNAME:$HGPORT1/show_bug.cgi?id=6
  ...
  Bug 6:
    ...
    - author: default@example.com
      id: 11
      tags: []
      text: https://treeherder.mozilla.org/#/jobs?repo=try&revision=5ca087d0b3b55321300624fe08ebbd5d12da3335
    component: TestComponent
    depends_on: []
    platform: All
    product: TestProduct
...
Pushing commit with bug number to user repo will post comment if enabled
  ...
  remote: adding file changes
  remote: added 1 changesets with 1 changes to 1 files
  recording push at http://$DOCKER_HOSTNAME:$HGPORT1/show_bug.cgi?id=7
...
Verify cookie auth works
  ...
  remote: adding file changes
  remote: added 1 changesets with 1 changes to 1 files
  recording push at http://$DOCKER_HOSTNAME:$HGPORT1/show_bug.cgi?id=8
...
Unicode in commit message works
  ...
  remote: adding file changes
  remote: added 1 changesets with 1 changes to 1 files (+1 heads)
  recording push at http://$DOCKER_HOSTNAME:$HGPORT1/show_bug.cgi?id=10
