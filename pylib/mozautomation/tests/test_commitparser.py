...
Desc: Bug 960081 - Make use of shared mock Notification in Dialer call log tests"""
    ...
    def test_reviewers(self):
        ...
        self.assertEqual(
            list(parse_reviewers(b"Bug 1 - some stuff; r?romulus")), [b"romulus"]
        )
        self.assertEqual(
        ...
        self.assertEqual(
            list(parse_reviewers(b"Bug 1 - More stuff; (r?romulus)")), [b"romulus"]
        )
        self.assertEqual(
            list(parse_reviewers(b"Bug 1 - More stuff; (r?romulus,remus)")),
            [b"romulus", b"remus"],
        ...
        self.assertEqual(
            list(parse_reviewers(b"Bug 1 - More stuff; r?romulus, a=test-only")),
            [b"romulus", b"test-only"],
        )
        self.assertEqual(
            list(parse_reviewers(b"Bug 1 - More stuff; r?romulus, ux-r=test-only")),
            [b"romulus"],
        )
        ...
        self.assertEqual(
            list(parse_reviewers(b"Bug 1 - More stuff.r=jimmy.jones, r=bill.mcneal")),
            [b"jimmy.jones", b"bill.mcneal"],
        )
        self.assertEqual(
            list(parse_reviewers(b"Bug 1 - More stuff,r=jimmy.")), [b"jimmy"]
        )
        ...
        self.assertEqual(
            list(parse_reviewers(b"Bug 123 - Blah blah; r=gps DONTBUILD (NPOTB)")),
            [b"gps"],
        )

        self.assertEqual(
            list(parse_reviewers(b"Bug 123 - Blah blah; r=gps DONTBUILD")), [b"gps"]
        )
    ...
    def test_requal_reviewers(self):
        ...
        # first with r? reviewer request syntax
        self.assertEqual(
            list(parse_requal_reviewers(b"Bug 1 - some stuff; r?romulus")), []
        )
        self.assertEqual(
            list(parse_requal_reviewers(b"Bug 1 - More stuff; r?romulus, r?remus")), []
        )
        self.assertEqual(
            list(parse_requal_reviewers(b"Bug 1 - More stuff; r?romulus,r?remus")), []
        )
        self.assertEqual(
            list(parse_requal_reviewers(b"Bug 1 - More stuff; r?romulus, remus")), []
        )
        self.assertEqual(
            list(parse_requal_reviewers(b"Bug 1 - More stuff; r?romulus,remus")), []
        )
        self.assertEqual(
            list(parse_requal_reviewers(b"Bug 1 - More stuff; (r?romulus)")), []
        )
        self.assertEqual(
            list(parse_requal_reviewers(b"Bug 1 - More stuff; (r?romulus,remus)")), []
        )
        ...
        self.assertEqual(
            list(parse_requal_reviewers(b"Bug 1 - More stuff; [r?remus, r?romulus]")),
            [],
        )
        self.assertEqual(
            list(parse_requal_reviewers(b"Bug 1 - More stuff; r?romulus, a=test-only")),
            [],
        )

        # now with r= review granted syntax
        self.assertEqual(
            list(parse_requal_reviewers(b"Bug 1 - some stuff; r=romulus")), [b"romulus"]
        )
        self.assertEqual(
            list(parse_requal_reviewers(b"Bug 1 - More stuff; r=romulus, r=remus")),
            [b"romulus", b"remus"],
        ...
        # bare r?
        self.assertEqual(list(parse_requal_reviewers(b"Bug 123 - Blah blah; r?")), [])
        self.assertEqual(
            list(
                parse_requal_reviewers(
                    b"Bug 1313324 - Cover the screensharing UI with browser chrome test, r="
    ...
    def test_rquestion_reviewers(self):
        ...
        # first with r? reviewer request syntax
        self.assertEqual(
            list(parse_rquestion_reviewers(b"Bug 1 - some stuff; r?romulus")),
            [b"romulus"],
        )
        self.assertEqual(
            list(parse_rquestion_reviewers(b"Bug 1 - More stuff; r?romulus, r?remus")),
            [b"romulus", b"remus"],
        )
        self.assertEqual(
            list(parse_rquestion_reviewers(b"Bug 1 - More stuff; r?romulus,r?remus")),
        ...
        self.assertEqual(
            list(parse_rquestion_reviewers(b"Bug 1 - More stuff; r?romulus, remus")),
            [b"romulus", b"remus"],
        )
        self.assertEqual(
            list(parse_rquestion_reviewers(b"Bug 1 - More stuff; r?romulus,remus")),
        ...
        self.assertEqual(
            list(parse_rquestion_reviewers(b"Bug 1 - More stuff; (r?romulus)")),
            [b"romulus"],
        )
        self.assertEqual(
            list(parse_rquestion_reviewers(b"Bug 1 - More stuff; (r?romulus,remus)")),
        ...
        self.assertEqual(
            list(
                parse_rquestion_reviewers(b"Bug 1 - More stuff; [r?remus, r?romulus]")
            ),
            [b"remus", b"romulus"],
        )
        self.assertEqual(
            list(
                parse_rquestion_reviewers(b"Bug 1 - More stuff; r?romulus, a=test-only")
            ),
            [b"romulus"],
        )
    ...
    def test_replace_reviewers(self):
        ...
        # first with r? reviewer request syntax
        self.assertEqual(
            replace_reviewers(b"Bug 1 - some stuff; r?romulus", [b"remus"]),
            b"Bug 1 - some stuff; r=remus",
        )
        self.assertEqual(
            replace_reviewers(b"Bug 1 - More stuff; r?romulus, r?remus", [b"remus"]),
            b"Bug 1 - More stuff; r=remus",
        )
        self.assertEqual(
            replace_reviewers(b"Bug 1 - More stuff; r?romulus,r?remus", [b"remus"]),
            b"Bug 1 - More stuff; r=remus",
        ...
        self.assertEqual(
            replace_reviewers(b"Bug 1 - More stuff; r?romulus, remus", [b"remus"]),
            b"Bug 1 - More stuff; r=remus",
        )
        self.assertEqual(
            replace_reviewers(b"Bug 1 - More stuff; r?romulus,remus", [b"remus"]),
        ...
        self.assertEqual(
            replace_reviewers(b"Bug 1 - More stuff; (r?romulus)", [b"remus"]),
            b"Bug 1 - More stuff; (r=remus)",
        )
        self.assertEqual(
            replace_reviewers(b"Bug 1 - More stuff; (r?romulus,remus)", [b"remus"]),
        ...
        self.assertEqual(
            replace_reviewers(b"Bug 1 - More stuff; [r?remus, r?romulus]", [b"remus"]),
            b"Bug 1 - More stuff; [r=remus]",
        )
        self.assertEqual(
            replace_reviewers(
                b"Bug 1 - More stuff; r?romulus, a=test-only", [b"remus"]
            ),
            b"Bug 1 - More stuff; r=remus, a=test-only",
        )
        self.assertEqual(
            replace_reviewers(
                b"Bug 1 - More stuff; r?romulus, ux-r=test-only", [b"remus", b"romulus"]
            ),
            b"Bug 1 - More stuff; r=remus,romulus, ux-r=test-only",
        )
        ...
        # make sure things work with different spacing
        self.assertEqual(
            replace_reviewers(b"Bug 1 - some stuff;r=romulus,r=remus", [b"remus"]),
            b"Bug 1 - some stuff;r=remus",
        )
        self.assertEqual(
            replace_reviewers(b"Bug 1 - More stuff.r=romulus, r=remus", [b"remus"]),
        ...
        self.assertEqual(
            replace_reviewers(
                b"Bug 123 - Blah blah; r=gps DONTBUILD (NPOTB)", [b"remus"]
            ),
            b"Bug 123 - Blah blah; r=remus DONTBUILD (NPOTB)",
        )
        self.assertEqual(
            replace_reviewers(b"Bug 123 - Blah blah; r=gps DONTBUILD", [b"remus"]),
            b"Bug 123 - Blah blah; r=remus DONTBUILD",
        )
        self.assertEqual(
            replace_reviewers(b"Bug 123 - Blah blah; r=gps (DONTBUILD)", [b"remus"]),
            b"Bug 123 - Blah blah; r=remus (DONTBUILD)",
        ...
        self.assertEqual(
            replace_reviewers(b"Bug 123 - Blah blah; r?", [b"remus"]),
            b"Bug 123 - Blah blah; r=remus",
        )
        self.assertEqual(
            replace_reviewers(b"Bug 123 - Blah blah; r? DONTBUILD", [b"remus"]),
            b"Bug 123 - Blah blah; r=remus DONTBUILD",
        )

    def test_backout_partial(self):
        # bug without node
        self.assertIsNone(parse_backouts(b"Bug 1 - More stuff; r=romulus"))
    ...
    def test_backout_single(self):
        # b'backed out'
        self.assertEqual(
            parse_backouts(b"Backed out changeset 6435d5aab611 (bug 858680)"),
            ([b"6435d5aab611"], [858680]),
        )

        # b'backout of'
        self.assertEqual(
            parse_backouts(b"backout of f9abb9c83452 (bug 1319111) for crashes, r=bz"),
            ([b"f9abb9c83452"], [1319111]),
        )

        # b'backout revision'
        self.assertEqual(
            parse_backouts(b"Backout revision 20a9d741cdf4 (bug 1354641) a=me"),
            ([b"20a9d741cdf4"], [1354641]),
        )

        # b'backout'
        self.assertEqual(
            parse_backouts(b"Backout b8601df335c1 (Bug 1174857) for bustage"),
...
"""
    ...
    def test_strip_commit_metadata(self):
        ...
        self.assertEqual(
            strip_commit_metadata(b"Bug 1 - foo\n\nMozReview-Commit-ID: abcdef"),
            b"Bug 1 - foo",
        )
    ...
    def test_parse_commit_id(self):
        ...
        self.assertEqual(parse_commit_id(b"MozReview-Commit-ID: foo123"), b"foo123")
        self.assertEqual(
            parse_commit_id(b"Bug 1 - foo\n\nMozReview-Commit-ID: abc456"), b"abc456"
        )
...
class TestAddHyperlinks(unittest.TestCase):
    def test_link_source_repo(self):
        self.assertEqual(
            add_hyperlinks(b"Source-Repo: not a link\n"), b"Source-Repo: not a link\n"
        )
        ...
        self.assertEqual(
            add_hyperlinks(b"Source-Repo: https://example.com?bad&escape=%20\n"),
