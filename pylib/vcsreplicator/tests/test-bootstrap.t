...
will be an indication of a successful bootstrap
  ...
  * * vcsreplicator.bootstrap error triggering replication of Mercurial repo {moz}/deleterepo: (255, b'pulling from ssh://hgssh/deleterepo', b'remote: requested repo deleterepo does not exist\nabort: no suitable response from remote hg') (glob)
...
Ensure the audit output is in the correct format
  ...
  {
      "{moz}/deleterepo": [
          "error triggering replication of Mercurial repo {moz}/deleterepo: (255, b'pulling from ssh://hgssh/deleterepo', b'remote: requested repo deleterepo does not exist\\nabort: no suitable response from remote hg')"
      ],
      "{moz}/filterrepo": [
