...
An SNS message should be sent with the event details
  ...
  vcsreplicator.pushnotifications heartbeat-1 message not relevant; ignoring
  vcsreplicator.pushnotifications querying pushlog data for /repo/hg/mozilla/mozilla-central
  vcsreplicator.snsnotifier processing message 10: changegroup.1 for https://hg.mozilla.org/mozilla-central
  vcsreplicator.snsnotifier uploading to S3: http://localhost:5001/moz-hg-events-us-west-2/events/*/0000000010-*.json (glob)
  vcsreplicator.snsnotifier sending SNS notification to arn:aws:sns:us-east-1:123456789012:hgmo-events
  vcsreplicator.snsnotifier finished processing message 10
  vcsreplicator.pushnotifications heartbeat-1 message not relevant; ignoring
  vcsreplicator.pushnotifications heartbeat-1 message not relevant; ignoring
  vcsreplicator.pushnotifications querying pushlog data for /repo/hg/mozilla/mozilla-central
  vcsreplicator.snsnotifier processing message 13: changegroup.1 for https://hg.mozilla.org/mozilla-central
  vcsreplicator.snsnotifier uploading to S3: http://localhost:5001/moz-hg-events-us-west-2/events/*/0000000013-*.json (glob)
  vcsreplicator.snsnotifier sending SNS notification to arn:aws:sns:us-east-1:123456789012:hgmo-events
  vcsreplicator.snsnotifier finished processing message 13
  ...
  vcsreplicator.snsnotifier processing message 14: obsolete.1 for https://hg.mozilla.org/mozilla-central
  vcsreplicator.snsnotifier message too large for SNS; dropping payload
  vcsreplicator.snsnotifier uploading to S3: http://localhost:5001/moz-hg-events-us-west-2/events/*/0000000014-*.json (glob)
  vcsreplicator.snsnotifier sending SNS notification to arn:aws:sns:us-east-1:123456789012:hgmo-events
  vcsreplicator.snsnotifier finished processing message 14
  ...
  POST /hgmo-events {
      "Message": [
          "{\"data\": {\"heads\": [\"2971b4149fdfe8541e8ddddd0a2dce39b90f5e70\"], \"pushlog_pushes\": [{\"push_full_json_url\": \"https://hg.mozilla.org/mozilla-central/json-pushes?version=2&full=1&startID=1&endID=2\", \"push_json_url\": \"https://hg.mozilla.org/mozilla-central/json-pushes?version=2&startID=1&endID=2\", \"pushid\": 2, \"time\": *, \"user\": \"user@example.com\"}], \"repo_url\": \"https://hg.mozilla.org/mozilla-central\", \"source\": \"serve\"}, \"data_url\": \"http://localhost:5001/moz-hg-events-us-west-2/events/*/0000000010-*.json\", \"type\": \"changegroup.1\"}" (glob)
      ],
      "MessageId": [
          "*" (glob)
      ],
  ...
  POST /hgmo-events {
      "Message": [
          "{\"data\": {\"heads\": [\"76bf70283ec77e25c4ce99d27dccc12d6ede5837\"], \"pushlog_pushes\": [{\"push_full_json_url\": \"https://hg.mozilla.org/mozilla-central/json-pushes?version=2&full=1&startID=2&endID=3\", \"push_json_url\": \"https://hg.mozilla.org/mozilla-central/json-pushes?version=2&startID=2&endID=3\", \"pushid\": 3, \"time\": *, \"user\": \"user@example.com\"}], \"repo_url\": \"https://hg.mozilla.org/mozilla-central\", \"source\": \"serve\"}, \"data_url\": \"http://localhost:5001/moz-hg-events-us-west-2/events/*/0000000013-*.json\", \"type\": \"changegroup.1\"}" (glob)
      ],
      "MessageId": [
          "*" (glob)
      ],
  ...
  POST /hgmo-events {
      "Message": [
          "{\"data_url\": \"http://localhost:5001/moz-hg-events-us-west-2/events/*/0000000014-*.json\", \"external\": true, \"repo_url\": \"https://hg.mozilla.org/mozilla-central\", \"type\": \"obsolete.1\"}" (glob)
      ],
      "MessageId": [
          "*" (glob)
      ],
