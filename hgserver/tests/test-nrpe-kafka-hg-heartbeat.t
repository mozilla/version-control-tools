...
Check should fail with no quorum in cluster
  ...
  [Error 19] NotEnoughReplicasError: ProduceResponsePayload(topic='pushdata', partition=0, error=19, offset=-1)
  CRITICAL - error writing to partition 1 (leader: *): NOT_ENOUGH_REPLICAS (glob)
  [Error 19] NotEnoughReplicasError: ProduceResponsePayload(topic='pushdata', partition=1, error=19, offset=-1)
  CRITICAL - error writing to partition 2 (leader: *): NOT_ENOUGH_REPLICAS (glob)
  [Error 19] NotEnoughReplicasError: ProduceResponsePayload(topic='pushdata', partition=2, error=19, offset=-1)
  CRITICAL - error writing to partition 3 (leader: *): NOT_ENOUGH_REPLICAS (glob)
  [Error 19] NotEnoughReplicasError: ProduceResponsePayload(topic='pushdata', partition=3, error=19, offset=-1)
  CRITICAL - error writing to partition 4 (leader: *): NOT_ENOUGH_REPLICAS (glob)
  [Error 19] NotEnoughReplicasError: ProduceResponsePayload(topic='pushdata', partition=4, error=19, offset=-1)
  CRITICAL - error writing to partition 5 (leader: *): NOT_ENOUGH_REPLICAS (glob)
  [Error 19] NotEnoughReplicasError: ProduceResponsePayload(topic='pushdata', partition=5, error=19, offset=-1)
  CRITICAL - error writing to partition 6 (leader: *): NOT_ENOUGH_REPLICAS (glob)
  [Error 19] NotEnoughReplicasError: ProduceResponsePayload(topic='pushdata', partition=6, error=19, offset=-1)
  CRITICAL - error writing to partition 7 (leader: *): NOT_ENOUGH_REPLICAS (glob)
  [Error 19] NotEnoughReplicasError: ProduceResponsePayload(topic='pushdata', partition=7, error=19, offset=-1)
