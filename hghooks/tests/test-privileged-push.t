...
provided neither MAGIC_WORDS nor a justification in their top commit.
  ...
  remote: To override, in your top commit, include the literal string, "PRIVILEGED PUSH:",
...
magic words with justification
  ...
  remote: adding file changes
  remote: added 1 changesets with 1 changes to 1 files
  remote: Successful push: 273d823fcfe3 by l3user@example.com (ACTIVE_SCM_LEVEL_3)
  remote: recorded push in pushlog
  remote: 
  remote: View your change here:
  remote:   https://hg.mozilla.org/not-mozilla-central/rev/273d823fcfe354317fdcef55e2572e7d4eab2350
  remote: recorded changegroup in replication log in *s (glob)
...
ACTIVE_SCM_LEVEL_3 and the magic words and justification are on the top commit.
  ...
  remote: Successful push: fccc1a127aa2 by l3user@example.com (ACTIVE_SCM_LEVEL_3)
  remote: recorded push in pushlog
  remote: 
  remote: View your changes here:
  remote:   https://hg.mozilla.org/not-mozilla-central/rev/fccc1a127aa223ab96a58e346f8d18f05a018174
  remote:   https://hg.mozilla.org/not-mozilla-central/rev/d31e4d9749038fea4b6a4aa77be8b46a117a3066
  remote:   https://hg.mozilla.org/not-mozilla-central/rev/47cda600c145d916fd27d5fc4b5b3e49ea22983c
  remote:   https://hg.mozilla.org/not-mozilla-central/rev/b3d1f05e604e22700272f995b4b3e02b83a9fec3
  remote: recorded changegroup in replication log in *s (glob)
