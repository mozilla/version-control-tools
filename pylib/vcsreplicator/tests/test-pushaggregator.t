...
Starting the replication consumer should result in the message being written
  ...
  got a heartbeat-1 message
  got a hg-changegroup-2: (repo: {moz}/mozilla-central, heads: ['8f2fa335d20b']) message
  got a hg-heads-1: (repo: {moz}/mozilla-central, heads: ['8f2fa335d20b'], last_push_id: 2) message
