...
def hook(ui, repo, node, source=None, **kwargs):
    ...
    if nspr_nodes or nss_nodes:
        if nspr_nodes:
            ui.write(
                b"(%d changesets contain changes to protected nsprpub/ "
        ...
        if nss_nodes:
            ui.write(
                b"(%d changesets contain changes to protected security/nss/ "
        ...
        if res:
            ...
            ui.write(b"%s\n" % header)
            ui.write(
                b"You do not have permissions to modify files under "
                b"nsprpub/ or security/nss/\n"
            )
            ui.write(b"\n")
            ui.write(
                b"These directories are kept in sync with the canonical "
            ...
            ui.write(b"\n")
            ui.write(
                b"Please contact the NSPR/NSS maintainers at nss-dev@mozilla.org or on IRC\n"
