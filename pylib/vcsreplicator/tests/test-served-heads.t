...
wait for the consumer to have no lag.
  ...
  vcsreplicator.consumer processing hg-changegroup-2: (repo: {moz}/mozilla-central, heads: ['77538e1ce4be']) from partition 0 offset 4
  vcsreplicator.consumer processing hg-heads-1: (repo: {moz}/mozilla-central, heads: ['77538e1ce4be'], last_push_id: 1) from partition 0 offset 5
...
Wait for it to be processed by the heads consumer daemon
  ...
  got a heartbeat-1 message
  got a heartbeat-1 message
  got a hg-changegroup-2: (repo: {moz}/mozilla-central, heads: ['4c9443886fe8', '4b11352745a6']) message
  got a hg-heads-1: (repo: {moz}/mozilla-central, heads: ['4b11352745a6', '4c9443886fe8'], last_push_id: 2) message
  ...
  vcsreplicator.consumer processing hg-changegroup-2: (repo: {moz}/mozilla-central, heads: ['4c9443886fe8', '4b11352745a6']) from partition 0 offset 8
  vcsreplicator.consumer processing hg-heads-1: (repo: {moz}/mozilla-central, heads: ['4b11352745a6', '4c9443886fe8'], last_push_id: 2) from partition 0 offset 9
  vcsreplicator.consumer updating replicated data for /repo/hg/mozilla/mozilla-central
...
But it isn't available on hgweb because the updates heads aren't written out
  ...
  {
  "error": "filtered revision '36638cc83b4d9084a2a38f41f345da73390ad05b' (not in 'replicatedserved' subset)"
  }
...
Re-enabling consumer will result in heads replication and changeset being visible
  ...
  got a heartbeat-1 message
  got a heartbeat-1 message
  got a hg-changegroup-2: (repo: {moz}/mozilla-central, heads: ['36638cc83b4d']) message
  got a hg-heads-1: (repo: {moz}/mozilla-central, heads: ['36638cc83b4d', '4c9443886fe8'], last_push_id: 3) message
