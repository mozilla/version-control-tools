...
User can't remote strip unless allowed
  ...
  $ hg debugpushkey ssh://$DOCKER_HOSTNAME:$HGPORT6/test-repo strip dummy '' faaa0821e83d9b1c7070b1e458a809a79173579c
...
User in whitelist can strip
  ...
  $ hg debugpushkey ssh://$DOCKER_HOSTNAME:$HGPORT6/test-repo strip dummy '' cd04635afb3cc9f4d8b8d074465a7e3d0d70908e
  remote: saved backup bundle to /repo/hg/mozilla/test-repo/.hg/strip-backup/cd04635afb3c-*remotestrip.hg (glob)
  remote: changeset will be deleted from pushlog: cd04635afb3cc9f4d8b8d074465a7e3d0d70908e
  remote: changeset will be deleted from pushlog: 0050780911c81eed28216c404bc64e6ecdab9a54
  remote: changeset rev will be updated in pushlog: faaa0821e83d9b1c7070b1e458a809a79173579c
  remote: changeset rev will be updated in pushlog: 85811c4bd2cd093cee28e98e7bb7a641965bf889
  True
